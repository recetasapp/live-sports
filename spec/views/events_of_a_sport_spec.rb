...
describe "Sport view" do
  ...
  it "should show an error if the sport id was not found" do
    ...
    visit sport_path :en, not_existing_sport_id
  ...
  it "should show the events for the selected sport" do
    ...
    within "tr#event_id_11" do
      expect(page).to have_link "Elche v Alicante", href: sport_event_path(:en, sport_id, 11)
    end
    within "tr#event_id_12" do
      expect(page).to have_link "Horn v Breda", href: sport_event_path(:en, sport_id, 12)
    end
    within "tr#event_id_13" do
      expect(page).to have_link "Rafal v Benejuzar", href: sport_event_path(:en, sport_id, 13)
    end
  end
